...
class EquipmentControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create equipment" do
    assert_difference("Equipment.count") do
      post equipment_index_url, params: { equipment: { description: @equipment.description, name: @equipment.name, photo: @equipment.photo, type: @equipment.type } }
    end
  ...
  test "should update equipment" do
    patch equipment_url(@equipment), params: { equipment: { description: @equipment.description, name: @equipment.name, photo: @equipment.photo, type: @equipment.type } }
